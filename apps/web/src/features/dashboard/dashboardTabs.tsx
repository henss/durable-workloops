...
export function getDashboardTabs(counts: Record<DashboardTab, number>) {
  return [
    ...
    { value: "new-plan", label: "New Plan", heading: "Submit a WorkLoop plan", description: "Paste a validated WorkLoop as JSON or YAML.", count: counts["new-plan"], icon: <FilePlus2 size={16} /> },
