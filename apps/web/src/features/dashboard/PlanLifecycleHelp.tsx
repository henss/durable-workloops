import { Badge, Box, Group, Paper, Stack, Text, ThemeIcon, useComputedColorScheme } from "@mantine/core";
    ...
    >
      <Stack gap={6}>
        <Group justify="space-between" gap="xs" wrap="nowrap" className="aw-lifecycle-header">
          ...
          <Box component="details" className="aw-lifecycle-details" data-testid="plan-lifecycle-disclosure">
            <Box component="summary" className="aw-lifecycle-summary">
            ...
            <Box className="aw-lifecycle-popover" p="sm">
              <Stack gap="xs">
                <Text size="sm" fw={750}>
        ...
        >
          {planLifecycleStages.map((stage, index) => (
            <Group key={stage.key} className="aw-lifecycle-step-wrap" gap={0} role="listitem" wrap="nowrap">
              ...
              >
                <ThemeIcon size="sm" variant={activeTab === stage.key ? "gradient" : "light"} aria-hidden>
